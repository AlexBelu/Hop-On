...
public class UserServiceTest {
    ...
    public void testLoadCustomers() throws Exception {
        ...
        UserService.copy();
        assertTrue(Files.exists(UserService.getPathCustomer()));
    }
    @Test
    public void testLoadPilots() throws Exception {
        UserService.copy();
        assertTrue(Files.exists(UserService.getPathPilot()));
    }
    @Test
    public void testLoadFlights() throws Exception {
        UserService.copy();
        assertTrue(Files.exists(UserService.getFlightPath()));
    }
    ...
    @Test
    public void testnu() throws IOException
    {UserService.loadPilotsfromFile("src/test/resources/JsonFilePilot.json");
     UserService.loadFlightsFromFile("src/test/resources/JsonFileFlight.json");
     Flight flight1 = new Flight(1, "Timisoara", "Londra", "29-05-2020");
     flight1.setUsernamePilot1("ddsad");
     flight1.setUsernamePilot2("smda");
        ArrayList<Flight> flights = new ArrayList<>();
       assertNotEquals(flight1,UserService.checkAvailabilityFlight(UserService.getPilots().get(0).getUsername()).get(0));
       assertNotNull(UserService.checkAvailabilityFlight(UserService.getPilots().get(0).getUsername()));
     UserService.getFlights().get(0).setUsernamePilot2("ddsad");
     UserService.getFlights().get(0).setUsernamePilot2("smda");
        Flight flight2 = new Flight(2, "Timisoara", "Berlin", "20-05-2020");
        Flight flight3 = new Flight(3, "Bucuresti", "Roma", "21-05-2020");
        Flight flight4 = new Flight(4, "Bucuresti", "Paris", "17-06-2020");
        Flight flight5 = new Flight(5, "Timisoara", "Paris", "20-06-2020");
        ...
        flights.add(flight5);
        flights.add(flight6);
        assertNotEquals(flights, UserService.checkAvailabilityFlight(UserService.getPilots().get(0).getUsername()));
    ...
    public void test2() throws IOException {
        ...
        assertNull(UserService.findPilot("NUEXISTA"));
    }
    ...
    public void test3() throws IOException {
        ...
        assertNull(UserService.findCustomer("NUEXISTA"));
    }
    ...
    public void test4() throws IOException {
        ...
        assertNull(UserService.getFlight(2100));
    }
